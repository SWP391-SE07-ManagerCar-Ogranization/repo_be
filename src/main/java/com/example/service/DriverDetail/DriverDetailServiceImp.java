...
//    @Override
//    public DriverDetail getDriverDetailByGroup(Integer id) {
//        return driverDetailRepository.findDriverDetailByGroupCar(groupCarRepository.findById(id).orElse(null));
//    }
